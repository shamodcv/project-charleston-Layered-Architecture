...
public class ReservationModel {
    ...
    public static boolean save(Reservation reservation) throws SQLException {
        String sql = "INSERT INTO Resavations(Res_ID, Guest_ID, Room_ID, Room_price,Check_in_Date,Check_out_Date) VALUES(?, ?, ?, ?, ?, ? )";
        ...
        pstm.setString(5, String.valueOf(reservation.getCheckInDate()));
        pstm.setString(6, String.valueOf(reservation.getCheckOutDate()));

        int affectedRows = pstm.executeUpdate();
        boolean isSave = affectedRows > 0;
        if (isSave){
            String sql2 = "INSERT INTO Resavations_detail(Res_ID, Room_ID, Room_price, Guest_ID, Guest_Name, Check_In_Date, Check_Out_Date) VALUES(?, ?, ?, ?, ?, ?, ? )";
            ...
            pst.setString(6, String.valueOf(reservation.getCheckInDate()));
            pst.setString(7, String.valueOf(reservation.getCheckOutDate()));
